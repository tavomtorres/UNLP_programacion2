...
PROCEDURE InsertarEnArbol(var arbol:Arbol_Disciplinas; var lista:Lista_Olim;lista_aux:Lista_Olim);
VAR
...
PROCEDURE GenerarArbol(var arbol:Arbol_Disciplinas; var lista:Lista_Olim;lista_aux:Lista_Olim);
BEGIN
          if arbol = nil then
             begin
...
VAR
   ...
   lista_aux:Lista_Olim;
BEGIN
  new(lista_aux);
   lista_aux:= lista;
          while lista <> nil do
               begin
                  GenerarArbol(arbol,lista,lista_aux);
                  lista:=lista^.sig;
               end;
